...
<>
    <div className="container">
        <div className="main-content flex gap-4 flex-wrap justify-center pt-5">
            ...
            <div key={i} className="item w-[250px] h-[680px] bg-[#FFF7FC] rounded-md shadow-xl relative hover:text-all i- bg-green-50">
                ...
                <div className="item-details m-[11px]">
                    ...
                    <div
                        ...
                        <ul className='list-disc pl-5'>
                            ...
                            <li> Display Size:  {item.Size}</li>
                              <li>RAM: {item.RAM}</li>
                              <li>Keyboard Type:{item.Type}</li>
                        </ul>
                    </div>
                ...
                <div
                    ...
                    <button onClick={ ()=> handelBuy(item) }
                        className='w-[228px] h-[45px] bg-[#3749BB0D] hover:text-white hover:bg-[#57d14c] rounded-full font-semibold text-[#3749bb] border-e border-2'>Buy</button>
                    <button onClick={ ()=> handelShow(item) }  className='w-[228px] h-[45px] rounded-full transition font-semibold text-[#666666] hover:bg-[rgba(201,243,85,0.9)] hover:text-black border-e border-2'>Show  more</button>
                </div>
            </div> 
